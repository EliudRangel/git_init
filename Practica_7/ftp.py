...
def connect_ftp(
    ...
    connection = FTP()
    connection.connect(host=host, port=port, timeout=4)
...
if __name__ == "__main__":
    ...
    # connect_ftp('192.168.11.3', 8022)
     #connect_ftp(host="ftp.mirror.nl", save_path="/Users/Roberto Rangel/Desktop/Prog Python/txt")
     connect_ftp(host="ftp.unicamp.br", save_path="/Users/Roberto Rangel/Desktop/Prog Python/txt")
     # connect_ftp(host="ftp.iij.ad.jp", save_path="/Users/Roberto Rangel/Desktop/Prog Python/txt")